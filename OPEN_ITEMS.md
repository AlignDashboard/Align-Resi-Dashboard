...
State as of 2026-09-18. IDs are stable — when an item closes, move
...
| A14 | **The Landing's Yardi market rent is 9.7% above the submarket, and the overstatement is three weeks old.** The comp export (HelloData, 36 buildings, as of 2026-09-15) puts the building's whole market rent table at **$1,827,976/mo** against the rent roll's **$2,004,929** — $176,953 a month, $2.12M a year. Three readings corroborate: the unit directory of 2026-08-25 ($1,805,509) and the statement's Aug 2026 gross potential ($1,804,359) agree with each other to 0.06% and sit within 1.5% of the comps, so the move happened **after 2026-08-25**. The statement shows the ramp — +12.1% in Jul, +6.1% in Aug, +11.1% again by the roll, **+32.2% in three months** against a comp set that moved 2–6%. The market's own answer agrees: 44 days on market against the ring's 26, no concessions advertised where 22% of the ring offers them, and one unit listed since 2026-04-15. Your call on what the table should read; the pipeline will restate itself off the next roll | Loss to lease everywhere it appears (36.5% published, **30.4%** on a comp-supported market rent), the Rent Capture block's whole deduction series, and A8's band argument | **yes** — the published 37% Loss to Lease KPI and both Landing tabs rest on this denominator |
